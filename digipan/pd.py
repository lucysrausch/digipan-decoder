...
class Decoder(srd.Decoder):
    ...
    options = (
        {'id': 'baudrate', 'desc': 'Baud rate', 'default': 8000000},
        {'id': 'num_data_bits', 'desc': 'Data bits', 'default': 13,
            'values': (5, 6, 7, 8, 9, 13)},
        {'id': 'parity_type', 'desc': 'Parity type', 'default': 'none',
            'values': ('none', 'odd', 'even', 'zero', 'one')},
        {'id': 'parity_check', 'desc': 'Check parity?', 'default': 'no',
            'values': ('yes', 'no')},
        {'id': 'num_stop_bits', 'desc': 'Stop bits', 'default': 0.0,
