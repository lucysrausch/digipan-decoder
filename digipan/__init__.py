...
'''
Decoder for Trophy DigiPan digital XRAY sensors. Basically a 1:1 copy of the UART decoder.
Probably doesn't really work with PulseView as I removed logging for efficiency reasons.
